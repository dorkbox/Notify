...
internal class AppAccessor : TweenAccessor<AppNotify> {
    companion object {
        const val X_POS = 0
        const val Y_POS = 1
        const val X_Y_POS = 2
    ...
    override fun getValues(target: AppNotify, tweenType: Int, returnValues: FloatArray): Int {
        when (tweenType) {
            X_POS -> {
    ...
    override fun setValues(target: AppNotify, tweenType: Int, newValues: FloatArray) {
        when (tweenType) {
            X_POS -> {
